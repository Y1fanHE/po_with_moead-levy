...
savedir = "tmp/{}/dem/".format(benchmarks[instance-1])

N, T, gen = 100, 20, 1500
sigma, nr = 0.9, 2
par = [1.3, round(1/size[instance-1], 5), 20]
...
for i in range(rep):
    ...
    res = optimize(instance, N, T, gen, dem, par, sigma, nr, True, 100)
